...
# user_add5 = base_lab.User_lab(name="shuang5",password="123456",qq_num="403060464",role_id=1)
...
# print(class_id.id)
class_id = Session.query(base_lab.Class).filter_by(class_name="python").first()
homework = Session.query(base_lab.Homework).filter_by(Class_id=class_id.id).first()
print(class_id.)
