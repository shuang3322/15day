...
'''人员信息修改'''
# show_studer = Session.query(base_lab.User_lab).filter_by(role_id="1").all()
# for item in show_studer:
#     print("ID号:\033[1;34;40m%s \033[0m 姓名:\033[1;34;40m%s \033[0m QQNUM:\033[1;34;40m%s \033[0m"%(item.id,item.name,item.qq_num))
#
# change_user = Session.query(base_lab.User_lab).filter_by(name="shuang9").first()
# change_user.qq_num = "403060467"
# Session.commit()
#
# show_studer_all = Session.query(base_lab.User_lab).filter_by(role_id="1").all()
...
# my_user.role_id=1
'''上课记录'''
# class_record_add = base_lab.Class_record(role_name="python",teacher="2018-1-29",schooltime="2018-1-29")
# Session.add(class_record_add)
# Session.commit()
'''增加作业'''
